...
# word_1 = word.encode()
# word_2 = word_1.decode()
# print(f"Ваш пароль - {word}, зашифрованный пароль - {word_1}, расшифрованный пароль - {word_2}")
...
word = input("Введите слово для проверки на пaлиндром: ")
